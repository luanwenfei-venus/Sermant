...
public class VisibilityServiceImpl implements VisibilityService {
    ...
    public void reconnectHandler() {
        ...
        if (client != null) {
            ...
            client.send(JSONObject.toJSONString(serverInfo).getBytes(StandardCharsets.UTF_8),0);
        }
    }
    ...
    public void stop() {
        ...
        if (client != null) {
            ...
            serverInfo.setInstanceId(BootArgsIndexer.getInstanceId());
            client.send(JSONObject.toJSONString(serverInfo).getBytes(StandardCharsets.UTF_8), Message.ServiceData.DataType.VISIBILITY_DATA_VALUE);
        }
    }
